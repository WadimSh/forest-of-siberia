    ...
    <section className={style.wrapper} ref={contactsRef}>
      ...
      <div className={style.overlay}>
        <ul className={style.list}>
          ...
          <li className={style.item}>
            <a className={style.link} href="https://t.me/lessibrf" target="_blank" aria-label="Telegram">
              <div className={style.telegram}></div>
            </a>
          </li>
          <li className={style.item}>
            <a className={style.link} href="https://wa.me/79257302695" target="_blank" aria-label="WhatsApp">
